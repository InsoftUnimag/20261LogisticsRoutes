...
1. **Scenario:** Confirmación exitosa de despacho
   ...
   - **Then:** El sistema asigna el conductor y el vehículo físico específico a la ruta, les cambia su respectivo estado a "en_ruta" y "en_transito", optimiza el orden de paradas, genera el manifiesto y la ruta pasa a estado "confirmada". El conductor recibe la ruta en su dispositivo.
