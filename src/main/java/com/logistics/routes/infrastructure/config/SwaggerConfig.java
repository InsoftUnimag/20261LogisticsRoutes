 ...
 *
 * <p>Acceso local: http://localhost:8080/swagger-ui.html
 * <p>JSON spec:   http://localhost:8080/api-docs
 *
 * <p>Incluye esquema de autenticación Bearer (JWT) para que los endpoints
