...
/**
 * Payload del evento RUTA_CERRADA enviado a Módulo 3 (SPEC-08 sección 6).
...
public record RutaCerradaEvent(
    ...
    @JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
    public record VehiculoInfo(UUID vehiculoId, String tipo) {}

    @JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
    public record ParadaInfo(UUID paradaId, UUID paqueteId, String estado, String motivoNoEntrega,
    ...
    public static RutaCerradaEvent from(Ruta ruta, Conductor conductor,
        ...
        return new RutaCerradaEvent(
                ...
                new ConductorInfo(
                        conductor.getId(),
                        conductor.getNombre(),
                        conductor.getModeloContrato().descripcion()),
                new VehiculoInfo(
                        vehiculo.getId(),
